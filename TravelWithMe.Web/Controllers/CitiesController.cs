...
namespace TravelWithMe.Web.Controllers
{
    public class CitiesController : ApiController
    {
        ...
        public IHttpActionResult PostCity(City city)
        {
            ...
            var dublicateCity = db.Cities.FirstOrDefault(x => x.Name == city.Name);

            if (dublicateCity != null)
            {
                return BadRequest(string.Format("The city name {0} is already exist", city.Name));
            }
