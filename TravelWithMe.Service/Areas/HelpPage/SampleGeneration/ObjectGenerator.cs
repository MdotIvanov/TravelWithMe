namespace TravelWithMe.Service.Areas.HelpPage.SampleGeneration
{
    using System;
                ...
                return new Dictionary<Type, Func<long, object>>
                           {
                               ...
                               {
                                   typeof(Int16),
                                   index => (Int16)(index % Int16.MaxValue)
                               },
                               {
                                   typeof(Int32),
                                   index => (Int32)(index % Int32.MaxValue)
                               },
                               ...
                               {
                                   typeof(UInt16),
                                   index => (UInt16)(index % UInt16.MaxValue)
                               },
                               {
                                   typeof(UInt32),
                                   index => (UInt32)(index % UInt32.MaxValue)
                               },
